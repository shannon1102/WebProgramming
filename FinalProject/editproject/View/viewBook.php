...
<link rel="stylesheet" href="./View/css/DetailBookStyle.css">
<p><button class ="btn btn-default" type"submit" onclick="location.href='../../editproject/View/User/cart.php'" >Go to Cart</button></p>
<div class ="table">
    <table width="450" border="1" style="border-collapse:collapse">
        ...
        <tr>
            <td style="color:#F30">Price: <?php echo $book['Price'] ?>$</td>
        </tr>
        <tr>
